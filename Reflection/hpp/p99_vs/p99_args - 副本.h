 ...
 **/
#define P00_VAARG_EMPTY_1 0
#define P00_VAARG_EMPTY_0 1
#define P99_IS_EMPTY(...)    P00_ISEMPTY(P99_HAS_COMMA(__VA_ARGS__))

#define P00_ISEMPTY(_0)   P99_PASTE2(P00_VAARG_EMPTY_,_0)//  P99_HAS_COMMA(P99_PASTE5(P00_IS_EMPTY_CASE_, _0, _1, _2, _3))
