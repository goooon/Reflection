 ...
 **/
#define P99_LAST(...) VS_HLPER(P99_CHS(P99_PRED(P00_NARG(__VA_ARGS__)), __VA_ARGS__))

/**
 ** @brief Obtain all elements but the last of a list.
 **/
#define P99_ALLBUTLAST(...) VS_HLPER(P99_PASTE2(P00_PRE,P99_PRED(P00_NARG(__VA_ARGS__)))(__VA_ARGS__))
